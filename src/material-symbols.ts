...
const variants: MaterialSymbolsVariant[] = [
  'Outlined',
  'Rounded',
  'Sharp'
]

declare type StylingOptions = {
  opsz: TwentyToFortyEight,
  wght: 100 | 200 | 300 | 400 | 500 | 600 | 700,
  FILL: 0 | 1,
  GRAD: -25 | 0 | 200
...
const baseStylingOptions: StylingOptions = {
  opsz: 48,
  wght: 400,
  FILL: 0,
  GRAD: 0
...
const materialSymbols = async (options: MaterialSymbolsOptions) => {
